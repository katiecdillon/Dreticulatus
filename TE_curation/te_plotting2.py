...
def parse_repeatmasker_out(rm_file, genome_size, bin_size, classes):
    ...
    for line in lines:
        ...
        te_class = fields[10].split('/')[0].strip()
...
def main():
    ...
    parser.add_argument("-c", "--classes", default="LINE,SINE,LTR,RC,DNA,Unknown", 
                        help="TE classes to include in plots, comma-separated (default: LINE,SINE,LTR,RC,DNA,Unknown)")
